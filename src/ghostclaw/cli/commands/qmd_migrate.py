...
class QMDMigrateCommand(Command):
    ...
    def configure_parser(self, parser: argparse.ArgumentParser):
        ...
        # status
        subparsers.add_parser("status", help="Show migration progress")

        # stop
        subparsers.add_parser("stop", help="Stop running migration")

        # trigger (manual)
        trigger_parser = subparsers.add_parser(
            "trigger", help="Manually trigger migration"
        )
